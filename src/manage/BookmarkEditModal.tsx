...
export default function BookmarkEditModal({ open, onClose, categories, allTags, editing, onSaved }: Props) {
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          ...
          <div className="flex flex-wrap gap-1.5">
            {allTags.length === 0 && <span className="text-xs text-gray-500">暂无标签，可在「标签」页签中创建</span>}
            {allTags.map(t => (
