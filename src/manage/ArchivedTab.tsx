    ...
    <div>
        ...
        <table className="w-full text-sm table-fixed">
          ...
          <tbody>
            {loading ? (
              ...
              <tr><td colSpan={5} className="py-12 text-center text-sm text-gray-500">没有归档的书签</td></tr>
            ) : (
              bookmarks.map(b => (
      ...
      <div className="sm:hidden space-y-3">
        {loading ? (
          ...
          <div className="py-12 text-center text-sm text-gray-500">没有归档的书签</div>
        ) : (
          bookmarks.map(b => (
            <div
              key={b.id}
